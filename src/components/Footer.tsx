...
function Footer() {
  ...
  return (
    <section className="w-full bg-text-primary text-smokewhite-custom">
      <div className="px-3 py-5 container mx-auto flx flex-col items-center divide-y-2 divide-text-secondary">
        <h1 className="font-extrabold text-2xl lg:text-4xl md:text-3xl main-text text-center pb-3">
          Teracce
        </h1>
        <div className="flex flex-col items-center divide-y-2 divide-text-secondary w-full md:flex-row md:divide-y-0">
          <div className="py-5 text-text-secondary w-full">
